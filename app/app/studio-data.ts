...
export type Settings = { provider: Provider; endpoint: string; llmModel: string; hasApiKey?: boolean; apiKey?: string | null; enginePath: string; pythonEnginePath: string; pythonScriptPath: string; pythonMemoryBudgetGib: number; sheetSagePythonPath: string; settingPath: string; musicPath: string; examplesPath: string; coversPath: string; abcNotesPath: string; stylePresets: string; saveFormat: SaveFormat; viewMode: ViewMode; outputDirectory: string };
...
export const initialSettings: Settings = { provider: 'none', endpoint: '', llmModel: '', apiKey: null, enginePath: '', pythonEnginePath: '', pythonScriptPath: '', pythonMemoryBudgetGib: 11, sheetSagePythonPath: '', settingPath: '', musicPath: '', examplesPath: '', coversPath: '', abcNotesPath: '', stylePresets: DEFAULT_STYLE_PRESETS, saveFormat: 'wav', viewMode: 'list', outputDirectory: '' };
