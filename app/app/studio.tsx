        ...
        if (playing) {
          ...
          for (let ringIndex = 0; ringIndex < rings.length; ringIndex++) {
            ...
            for (let i = 0; i < points; i++) {
              ...
              const radius = Math.max(baseRadius * 0.1, baseRadius + (value - 0.5) * baseRadius * visualizerAmplitude);
