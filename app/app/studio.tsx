...
const STEM_MODE_CONFIG = {
  ...
  full: { stems: ['vocals', 'drums', 'bass', 'other'] as const, menuSub: '보컬+드럼+베이스+그 외 (4갈래)', description: '보컬·드럼·베이스·그 외 악기 4갈래', dialogTitle: 'STEM 분리', failureHint: 'STEM 분리에 실패했습니다. audio.cpp가 해당 분리 모델을 포함해 빌드되어 있는지, 모델 파일이 있는지 확인해 주세요.' },
  full6: { stems: ['vocals', 'drums', 'bass', 'guitar', 'piano', 'other'] as const, menuSub: '보컬+드럼+베이스+기타(guitar)+피아노+그 외 (6갈래)', description: '보컬·드럼·베이스·기타(guitar)·피아노·그 외 악기 6갈래', dialogTitle: 'STEM 분리', failureHint: 'STEM 분리에 실패했습니다. audio.cpp가 해당 분리 모델을 포함해 빌드되어 있는지, 모델 파일이 있는지 확인해 주세요.' },
