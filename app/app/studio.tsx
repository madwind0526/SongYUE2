        ...
        if (playing) {
          ...
          for (let ringIndex = 0; ringIndex < rings.length; ringIndex++) {
            ...
            for (let i = 0; i < points; i++) {
              ...
              const radius = baseRadius + value * baseRadius * visualizerAmplitude;
