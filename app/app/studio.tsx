...
function PostProcessDialog({ project, onClose, notify }: { project: Project; onClose: () => void; notify: (text: string, error?: boolean) => void }) {
  ...
  useEffect(() => {
    ...
    const rings = Array.from({ length: ringCount }, (_, i) => ({
      radiusFactor: 0.1 + (i / (ringCount - 1)) * 0.24,
      hue: 190 + ((i * 37) % 100),
        ...
        <div className="pp-layout">
          <div className="pp-eq-panel">
            ...
            <div className="pp-eq-footer">
              ...
              <div className="pp-visualizer-wrap">
...
export default function Studio() {
  ...
  return <div className="studio-shell">
    ...
    {postProcessTarget && <PostProcessDialog project={postProcessTarget} onClose={() => setPostProcessTarget(null)} notify={notify}/>}
  </div>;
}
