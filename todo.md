...
- [x] **VoxCPM2 제거 (2026-09-25)**: 실제로 써 보니 여성 목소리 설명이 남성 목소리로 나오고, 한국어 문장 중간에 유럽어 억양으로 바뀌어 사용 불가로 판단해 코드·모델 파일(2.8 GB)을 삭제. T2S는 Qwen3-TTS VoiceDesign과 Typecast로 남김.
